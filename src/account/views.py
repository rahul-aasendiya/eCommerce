...
def login_view(request):
	...
	return render(request,"account/login.html",{"form":form,"form2":form2,"title":title,"title2":title2})
...
def edit_all(request):
	...
	return render(request,'account/editall.html',{'title':title,"form":form})
